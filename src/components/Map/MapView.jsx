...
export default forwardRef(function MapView({ darkMode, mapMode, steps, meta, locations, onStepClick, onMapMove, highlightedZone, timelineHoverFrac }, ref) {
  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      />
      {/* High mode overlay: subtle film grain noise */}
      {mapMode === 'high' && (
        <div
          style={{
            position: 'absolute',
            ...
            zIndex: 4,
            opacity: 0.035,
            backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='turbulence' baseFrequency='0.7' numOctaves='3' seed='42' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)'/%3E%3C/svg%3E")`,
